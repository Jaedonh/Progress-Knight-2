...
const jobBaseData = {
    ...
    "Farmer": {name: "Farmer", maxXp: 100, income: 9000},
    "Fisherman": {name: "Fisherman", maxXp: 200, income: 15000},
    "Miner": {name: "Miner", maxXp: 400, income: 40000},
    "Blacksmith": {name: "Blacksmith", maxXp: 800, income: 80000},
    "Merchant": {name: "Merchant", maxXp: 1600, income: 150000},
    ...
    "Centenary": {name: "Centenary", maxXp: 100000, income: 300000},
    "Knight": {name: "Knight", maxXp: 1000000, income: 10000000},
    "Veteran Knight": {name: "Veteran Knight", maxXp: 7500000, income: 30000000},
    "Holy Knight": {name: "Holy Knight", maxXp: 40000000, income: 5000000},
    "Lieutenant General": {name: "Lieutenant General", maxXp: 150000000, income: 500000000},

    "Student": {name: "Student", maxXp: 100000, income: 10000000},
    "Apprentice Mage": {name: "Apprentice Mage", maxXp: 1000000, income: 10000000},
    "Adept Mage": {name: "Adept Mage", maxXp: 10000000, income: 95000000},
    "Master Wizard": {name: "Master Wizard", maxXp: 100000000, income: 700000000},
    "Archmage": {name: "Archmage", maxXp: 10000000000, income: 3500000000},
	"Chronomancer": {name: "Chronomancer", maxXp: 2000000000000, income: 10000000000},
    "Chairman": {name: "Chairman", maxXp: 20000000000000, income: 100000000000},
	"Imperator": {name: "Imperator", maxXp: 9000000000000000, income: 600000000000},
	
	"Corrupted": {name: "Corrupted", maxXp: 100000000000000, income: 2500000000000},
    "Void Slave": {name: "Void Slave", maxXp: 650000000000000, income: 200000000000000}, 
    "Void Fiend": {name: "Void Fiend", maxXp: 18000000000000000, income: 60000000000000}, 
    "Abyss Anomaly": {name: "Abyss Anomaly", maxXp: 18000000000000000, income: 120000000000000}, 
	"Void Wraith": {name: "Void Wraith", maxXp: 180000000000000000, income: 500000000000000}, 
    "Void Reaver": {name: "Void Reaver", maxXp: 2600000000000000000, income: 2500000000000000}, 
	"Void Lord": {name: "Void Lord", maxXp: 28000000000000000000, income: 10000000000000000},
	"Abyss God": {name: "Abyss God", maxXp: 400000000000000000000, income: 100000000000000000},
...
const itemBaseData = {
    ...
    "Tent": {name: "Tent", expense: 1, effect: 1.4},
    "Wooden Hut": {name: "Wooden Hut", expense: 10, effect: 2},
    "Cottage": {name: "Cottage", expense: 75, effect: 3.5},
    "House": {name: "House", expense: 30, effect: 6},
    "Large House": {name: "Large House", expense: 250, effect: 12},
    "Small Palace": {name: "Small Palace", expense: 3000, effect: 25},
    "Grand Palace": {name: "Grand Palace", expense: 5000, effect: 60},
	"Town Ruler": {name: "Town Ruler", expense: 3000, effect: 120},
	"City Ruler": {name: "City Ruler", expense: 1100, effect: 500},
	"Nation Ruler": {name: "Nation Ruler", expense: 1300, effect: 1200},
	"Pocket Dimension": {name: "Pocket Dimension", expense: 4900, effect: 5000},
    "Void Realm": {name: "Void Realm", expense: 12100, effect: 15000},
	"Void Universe": {name: "Void Universe", expense: 2000, effect: 30000},
	"Astral Realm": {name: "Astral Realm", expense: 1600, effect: 150000},
	"Galactic Throne": {name: "Galactic Throne", expense: 5000, effect: 300000},
    ...
    "Steel Longsword": {name: "Steel Longsword", expense: 100, effect: 2, description: "Military XP"},
    "Butler": {name: "Butler", expense: 750, effect: 1.5, description: "Happiness"},
    "Sapphire Charm": {name: "Sapphire Charm", expense: 500, effect: 3, description: "Magic XP"},
    "Study Desk": {name: "Study Desk", expense: 1000, effect: 2, description: "Ability XP"},
    "Library": {name: "Library", expense: 100, effect: 2, description: "Ability XP"},
	"Observatory": {name: "Observatory", expense: 1400, effect: 5, description: "Magic XP"},
	"Mind's Eye": {name: "Mind's Eye", expense: 3250, effect: 10, description: "Fundamentals XP"},
	"Void Necklace": {name: "Void Necklace", expense: 2800, effect: 3, description: "Void Manipulation XP"},
    "Void Armor": {name: "Void Armor", expense: 1970, effect: 3, description: "The Void XP"},
	"Void Blade": {name: "Void Blade", expense: 5020, effect: 3, description: "Ability XP"},
	"Void Orb": {name: "Void Orb", expense: 1200, effect: 3, description: "Void Manipulation XP"},
	"Void Dust": {name: "Void Dust", expense: 250, effect: 3, description: "The Void XP"},
	"Celestial Robe": {name: "Celestial Robe", expense: 3000, effect: 5, description: "Galactic Council XP"},
	"Universe Fragment": {name: "Universe Fragment", expense: 1800, effect: 3, description: "Ability XP"},
	"Multiverse Fragment": {name: "Multiverse Fragment", expense: 2000, effect: 5, description: "Happiness"},
